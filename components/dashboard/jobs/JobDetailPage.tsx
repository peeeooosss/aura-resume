...
import { ArrowLeft, MapPin, Briefcase, DollarSign, Clock, ExternalLink, Heart, CheckCircle, XCircle, Sparkles, Zap, Shield } from 'lucide-react';
      ...
      <div className="bg-slate-900/80 backdrop-blur-xl border border-slate-800 rounded-3xl overflow-hidden">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <div className="flex items-center gap-2">
                <span className={cn('px-3 py-1 text-lg font-bold rounded-xl border bg-slate-800/50 border-slate-700', scoreColorClass(job.matchScore))}>
                  {job.matchScore}%
                </span>
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                ...
                className="px-5 py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-medium rounded-xl transition-colors flex items-center gap-2"
              >
        ...
        <div className="p-8 grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-4">AI Match Analysis</h2>
              <p className="text-slate-300 leading-relaxed">{job.matchReasoning}</p>
            </section>
          </div>

          <div className="space-y-6">
            <div className="bg-slate-800/50 rounded-2xl p-6">
              <h3 className="font-semibold text-white mb-4">Match Breakdown</h3>
            ...
            <div className="bg-slate-800/50 rounded-2xl p-6">
              <h3 className="font-semibold text-white mb-4">Skills Match</h3>
